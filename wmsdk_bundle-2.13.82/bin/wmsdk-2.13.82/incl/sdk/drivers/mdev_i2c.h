 ...
 * @return number of bytes read on success
 */
int i2c_drv_slv_dma_read(mdev_t *dev, uint8_t *buf, uint32_t nbytes);
 ...
 * @param[in] txtout Tx timeout value in micro seconds, or zero to
 *            disable timeout.
 * @param[in] rxtout Rx timeout value in micro seconds, or zero to
 *            disable timeout.
 */

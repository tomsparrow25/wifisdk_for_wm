 ...
 *
 * AES API can is used for encryption and decrpytion of plain text and
 * cipher text repectively. Before any operation first a key, relavant to
...
#define AES_CCM_AUTH_E  -181  /* AES-CCM Authentication check failure */

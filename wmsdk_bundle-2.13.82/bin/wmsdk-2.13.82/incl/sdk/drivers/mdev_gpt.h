...
*/
/*! \file mdev_gpt.h
 *  \brief Genereal Purpose Timer (GPT) Driver
 *
 * General Purpose Timer (GPT) driver provides mdev interface
 * to use 4 general purpose hardware timers in MC200.
 *
 ...
 * -# gpt_drv_setcb() should be used to set GPT calback function.
 ...
 *  @param[in] toff Nunber of cycles of GPT the output will be Off.
 */

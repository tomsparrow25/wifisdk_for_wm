...
typedef PACK_START struct cipher_key_buf
{
#if 0
...
typedef struct _tdksKeyMgmtInfoSta_t
{
    UINT8 ANonce[NONCE_SIZE];
    UINT8 SNonce[NONCE_SIZE];
    UINT8 KCK[TDLS_MIC_KEY_SIZE];
    TDLS_KeyData_t pwsKeyData;
} tdlsKeyMgmtInfoSta_t;
#endif

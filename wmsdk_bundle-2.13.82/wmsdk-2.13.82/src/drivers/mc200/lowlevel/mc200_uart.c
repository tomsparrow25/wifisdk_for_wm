...
static void UART_Configure_Dividers(UART_ID_Type uartNo, uint32_t baudRate)
{
	...
	/* Following values are suggested ones to get correct baudrates for
	 * uart operation, see mc200_clock.c file for more details.
	 */
	uartClkSrcDiv.clkDivisor = 0x3E8;

	if (CLK_GetSystemClk() == 200000000) {
		switch (baudRate) {
		case 9600:
		case 115200:
		case 256000:
			...
			break;
		case 500000:
			uartClkSrcDiv.clkDividend = 0x7A;
			break;
		case 1000000:
		case 1500000:
			uartClkSrcDiv.clkDividend = 0xF2;
			break;
		default:
			uartClkSrcDiv.clkDividend = 0xE2;
			break;
		}
	} else if (CLK_GetSystemClk() == 32000000) {
		switch (baudRate) {
		case 9600:
			uartClkSrcDiv.clkDividend = 0x1F4;
			break;
		case 14400:
		case 56000:
		case 115200:
			uartClkSrcDiv.clkDividend = 0x1CD;
			break;
		case 128000:
		case 256000:
			uartClkSrcDiv.clkDividend = 0x200;
			break;
		default:
			uartClkSrcDiv.clkDividend = 0x1CD;
			break;
		...
		/* By default maintain 1/8 ratio for clkDividend/clkDivisor */
		uartClkSrcDiv.clkDividend = 0x7D;
	}

...
#define IEEEtypes_MAX_BSS_DESCRIPTS    12
...
} PACK_END IEEEtypes_8021x_PacketType_e;
...
} PACK_END IEEEtypes_8021x_CodeType_e;
...
} PACK_END IEEEtypes_CcmpHeader_t;
...
} PACK_END IEEEtypes_TkipHeader_t;
...
} PACK_END IEEEtypes_BlockAckReq_t;
...
}PACK_END IEEEtypes_NDPAFrameBody_t;
...
}PACK_END IEEEtypes_NDPAFrame_t;
/*-------------------------------------------------*/
...
PACK_END IEEEtypes_FhParamElement_t;
...
PACK_END IEEEtypes_DsParamElement_t;
...
PACK_END IEEEtypes_CfParamElement_t;
...
PACK_END IEEEtypes_TimElement_t;
...
PACK_END IEEEtypes_IbssParamElement_t;
...
} PACK_END IEEEtypes_SsIdL_HidSsId_t;
...
} PACK_END IEEEtypes_SsIdLElement_t;
...
} PACK_END IEEEtypes_WPS_DataElement_t;
...
** on BssConfig_t and ROM code.
*/
} PACK_END IEEEtypes_ExtCapability_t;
...
PACK_END IEEEtypes_HT_Cap_Info_t;
...
PACK_END IEEEtypes_HT_Mac_Params_t;
...
typedef PACK_START struct
{
    ...
    UINT16  Reserved2      : 4;
}PACK_END IEEEtypes_HT_Ext_Cap_t;
...
} PACK_END IEEEtypes_HT_TXBF_Cap_t;
...
} PACK_END IEEEtypes_HT_AS_Cap_t;
...
} PACK_END IEEEtypes_LinkAdaptCtrl_t;
...
} PACK_END IEEEtypes_HT_Capability_t;
...
} PACK_END IEEEtypes_HT_Information_t;
...
} PACK_END IEEEtypes_20N40_BSS_Coexist_t;
...
} PACK_END IEEEtypes_OBSS_ScanParam_t;
...
} PACK_END IEEEtypes_VHT_Supp_MCS_Set_t;
...
} PACK_END IEEEtypes_VHT_Capability_t;
...
} PACK_END IEEEtypes_VHT_Op_Info_t;
...
} PACK_END IEEEtypes_VHT_Operation_t;
...
} PACK_END IEEEtypes_VHT_OpMode_t;
...
} PACK_END IEEEtypes_VHT_OpModeNotification_t;
...
} PACK_END IEEEtypes_WIde_BW_CS_t;
...
typedef PACK_START struct
{
    ...
    IEEEtypes_Len_t       Len;
    IEEEtypes_AId_t       Aid;     
} PACK_END IEEEtypes_AIDElement_t;
...
} PACK_END IEEEtypes_RrmEnabledCapabilities_t;
...
} PACK_END IEEEtypes_ApChanRptElement_t;
...
} PACK_END IEEEtypes_ReportDetailLevel_e;
...
typedef PACK_START struct
{
    ...
    IEEEtypes_ReportDetailLevel_e RptDetailLevel;

} PACK_END IEEEtypes_ReportingDetailElement_t;
...
} PACK_END IEEEtypes_RequestElement_t;
...
} PACK_END IEEEtypes_RegulatoryTriplet_t;
...
} PACK_END IEEEtypes_SubbandTriplet_t;
...
} PACK_END IEEEtypes_CountryInfoTriplet_t;
...
} PACK_END IEEEtypes_CountryInfoElement_t;
...
} PACK_END IEEEtypes_WiFi_TPCReportElement_t;
...
PACK_END IEEEtypes_ChannelSwitchElement_t;
...
PACK_END IEEEtypes_IbssDfsElement_t;
...
PACK_END IEEEtypes_SupportedChannelsElement_t;
...
typedef PACK_START struct
{
    ...
    UINT8                   currRegClass;
    UINT8                   suppRegClass;
}PACK_END IEEEtypes_SupportedRegClasses_t;
...
PACK_END IEEEtypes_ExtChannelSwitchElement_t;
...
PACK_END IEEEtypes_BSSLoadElement_t;
...
PACK_END IEEEtypes_WPAElement_t;
...
PACK_END IEEEtypes_RSNCapability_t;
...
PACK_END IEEEtypes_RSNElement_t;
...
} PACK_END IEEEtypes_FT_CapabilityPolicy_t;
...
} PACK_END IEEEtypes_MobilityDomainElement_t;
...
} PACK_END IEEEtypes_GtkKeyInfo_t;
...
} PACK_END IEEEtypes_FT_MICControl_t;
...
} PACK_END IEEEtypes_FastBssTransElement_t;
...
} PACK_END IEEEtypes_TimeoutIntervalElement_t;
...
} PACK_END IEEEtypes_RICDataElement_t;
...
} PACK_END IEEEtypes_RICResource_e;
...
} PACK_END IEEEtypes_RICDescElement_t;
...
} PACK_END IEEEtypes_ManagementMICElement_t;
...
} PACK_END IEEEtypes_PhyParamElement_t;
...
} PACK_END IEEEtypes_SsParamElement_t;
...
typedef PACK_START struct
{
    ...
    IEEEtypes_Len_t         Len;
    UINT8                   chan2Offset;
} PACK_END IEEEtypes_SecondaryChannelOffset_t;
...
typedef PACK_START struct
{
    ...
    UINT8                   Oui[4];
    UINT8                   Data[1];
} PACK_END IEEEtypes_WPSElement_t;
...
typedef PACK_START struct
{
    ...
    IEEEtypes_Len_t         Len;
    UINT8                   Data[1];
} PACK_END IEEEtypes_WAPIElement_t;
#endif

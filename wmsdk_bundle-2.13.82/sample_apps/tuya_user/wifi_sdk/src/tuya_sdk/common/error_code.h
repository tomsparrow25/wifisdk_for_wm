...
#define OPRT_TY_WS_PART_ERR INCREMENT(OPRT_EC_STARAT,17)
#define OPRT_CR_CJSON_ERR INCREMENT(OPRT_EC_STARAT,18)
#define OPRT_PSM_SET_ERROR INCREMENT(OPRT_EC_STARAT,19)
#define OPRT_PSM_GET_ERROR INCREMENT(OPRT_EC_STARAT,20)
#define OPRT_CJSON_PARSE_ERR INCREMENT(OPRT_EC_STARAT,21)
#define OPRT_CJSON_GET_ERR INCREMENT(OPRT_EC_STARAT,22)

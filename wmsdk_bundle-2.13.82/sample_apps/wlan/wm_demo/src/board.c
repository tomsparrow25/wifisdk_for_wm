...
int board_button_1()
{
	GPIO_PinMuxFun(GPIO_10, PINMUX_FUNCTION_0);
	GPIO_SetPinDir(GPIO_10, GPIO_INPUT);
...
int board_button_2()
{
	...
	GPIO_SetPinDir(GPIO_7, GPIO_INPUT);
...
int board_button_3()
{
	GPIO_PinMuxFun(GPIO_11, PINMUX_FUNCTION_0);
	GPIO_SetPinDir(GPIO_11, GPIO_INPUT);
